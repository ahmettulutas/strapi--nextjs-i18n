...
export const BrandButton = (props: ButtonProps) => {
  return (
    <Button
      ...
      className="my-4 p-2 text-white font-light rounded-3xl border-2 border-solid border-[#38269E] bg-[#4D3BB3] from-transparent via-opacity-10 from-opacity-4 to-opacity-4 bg-radial-gradient shadow-inner hover:bg-red-300"
      {...props}
    ></Button>
  );
};
